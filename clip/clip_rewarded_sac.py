...
class CLIPRewardedSAC(SAC):
    ...
    def _load_modules(self):
        ...
        print("OpenCLIP Model is loaded properly")
    ...
    def train(self, gradient_steps: int, batch_size: int = 100) -> None:
        print(f"Training model for {gradient_steps} gradient steps...")
        self._log()
        print("Calling super().train()")
        super().train(gradient_steps, batch_size)
        print(f"Finished training for {gradient_steps} gradient steps.")
    ...
    def _setup_learn(
        ...
        *args,
        ...
        print(f"Setting up learning with total_timesteps={total_timesteps}...")
    ...
    def learn(self: SelfCLIPRewardedSAC, *args, **kwargs) -> SelfCLIPRewardedSAC:
        print("Starting to learn the model...")
        assert not self.inference_only
        self.previous_num_timesteps = 0
        self.previous_num_episodes = 0
        print("Calling super().learn()")
